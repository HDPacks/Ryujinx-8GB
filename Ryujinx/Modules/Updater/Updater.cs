...
#pragma warning restore SYSLIB0014
        ...
        public static bool CanUpdate(bool showWarnings)
        {
            ...
            if (Program.Version.Contains("Custom") || !ReleaseInformations.IsValid())
            {
                if (showWarnings)
                {
                    GtkDialog.CreateWarningDialog("You cannot update a custom build of Ryujinx!", "Please visit HDPacks.com if you're looking for a custom build update.\nPlease download Ryujinx at https://ryujinx.org/ if you are looking for an official version.");
                }
