...
#pragma warning restore SYSLIB0014
        ...
        public static bool CanUpdate(bool showWarnings)
        {
            ...
            if (Program.Version.Contains("Custom") || !ReleaseInformation.IsValid())
            {
                if (showWarnings)
                {
                    GtkDialog.CreateWarningDialog("You cannot update a custom build of Ryujinx!", "Please download Ryujinx at https://ryujinx.org/ if you are looking for the official version.");
                }
